...
HRESULT Scene::Init(ID3D11Device* g_pd3dDevice, ID3D11RenderTargetView* g_mainRenderTargetView, int sWidth, int sHeight, HWND hwnd)
{
	...
	m_Camera->SetPosition(5.0f, 10.0f, -25.0f);
	...
	result = m_Katavictim->Init(hwnd, L"GameEngine/Data/Objects/Item Bag.obj", L"GameEngine/Data/Objects/moneybag.tga", Vector3(1.75f, 1.75f, 1.75f), g_pd3dDevice);
	...
	result = m_Katavictim2->Init(hwnd, L"GameEngine/Data/Objects/hammer.obj", L"GameEngine/Data/Objects/hammer.tga", Vector3(0.25f, 0.25f, 0.25f), g_pd3dDevice);
	...
	result = m_Katavictim3->Init(hwnd, L"GameEngine/Data/Objects/Teapot.obj", L"GameEngine/Data/Objects/teapot.tga", Vector3(7.0f, 7.0f, 7.0f), g_pd3dDevice);
...
bool Scene::Update(ID3D11DeviceContext* g_pd3dDeviceContext, IDXGISwapChain* g_pSwapChain, ID3D11RenderTargetView* g_mainRenderTargetView, ID3D11DepthStencilView* g_pDepthStencilView, ImVec4 color, int axisX,int axisY, Matrix g_pProjectionMatrix, Matrix g_pWorldMatrix, Matrix g_pOrthoMatrix)
{
