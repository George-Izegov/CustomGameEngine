...
void    ImGui_ImplWin32_NewFrame(int& axisX, int& axisY)
{
    ImGuiIO& io = ImGui::GetIO();
    ...
    io.KeySuper = false;
    if (io.KeysDown[39]) // Up Arrow
        axisX = 1;
    else if (io.KeysDown[37]) // Down Arrow
        axisX = -1;
    else
        axisX = 0;

    if (io.KeysDown[38]) // Right Arrow
        axisY = 1;
    else if (io.KeysDown[40]) // Left Arrow
        axisY = -1;
    else
        axisY = 0;
